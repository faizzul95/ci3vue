  ...
  >
    ...
    >
      <g id="Layer_1">
        ...
        <g class="icon-quote-circle-st1">
          <g>
            <path
              class="icon-quote-circle-st2"
...
<style type="text/css">
.icon-quote-circle-st0 {
  fill: #e0e0d1;
}
.icon-quote-circle-st1 {
  opacity: 0.2;
}
.icon-quote-circle-st2 {
  fill: #231f20;
}
.icon-quote-circle-st3 {
  fill: #4f5d73;
}
</style>
