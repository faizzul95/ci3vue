    ...
    >
        ...
        >
            <g id="Layer_1">
                ...
                <g class="icon-email-circle-st1">
                    <path
                        class="icon-email-circle-st2"
...
<style type="text/css">
.icon-email-circle-st0 {
    fill: #77b3d4;
}
.icon-email-circle-st1 {
    opacity: 0.2;
}
.icon-email-circle-st2 {
    fill: #231f20;
}
.icon-email-circle-st3 {
    fill: #ffffff;
}
</style>
