<template>
  <icon-base icon-name="contrast-circle" :width="width" :height="height" :icon-color="iconColor">
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <circle 
        class="icon-contrast-circle-st0" 
        cx="32" 
        cy="32" 
        r="32" 
        :style="[backgroundColor ? {} : {'fill': 'none'}]"
      />
      <g class="icon-contrast-circle-st1">
        <path
          class="icon-contrast-circle-st2"
          d="M54.5,32.5h-2.6c-0.1-1.6-0.4-3.2-0.9-4.6l2.4-1c0.8-0.3,1.1-1.2,0.8-2c-0.3-0.8-1.2-1.1-2-0.8l-2.4,1
        ...
        <path
          class="icon-contrast-circle-st2"
          d="M32,20c-7.7,0-14,6.3-14,14s6.3,14,14,14s14-6.3,14-14S39.7,20,32,20z M21,34c0-6.1,4.9-11,11-11v22
		C25.9,45,21,40.1,21,34z"
        />
      </g>
      <g>
        <path
          class="icon-contrast-circle-st3"
          d="M54.5,30.5h-2.6c-0.1-1.6-0.4-3.2-0.9-4.6l2.4-1c0.8-0.3,1.1-1.2,0.8-2c-0.3-0.8-1.2-1.1-2-0.8l-2.4,1
        ...
        <path
          class="icon-contrast-circle-st3"
          d="M32,18c-7.7,0-14,6.3-14,14s6.3,14,14,14s14-6.3,14-14S39.7,18,32,18z M21,32c0-6.1,4.9-11,11-11v22
...
<style type="text/css">
.icon-contrast-circle-st0 {
  fill: #4f5d73;
}
.icon-contrast-circle-st1 {
  opacity: 0.2;
}
.icon-contrast-circle-st2 {
  fill: #231f20;
}
.icon-contrast-circle-st3 {
  fill: #e0e0d1;
}
</style>
