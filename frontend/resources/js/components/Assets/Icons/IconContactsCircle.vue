    ...
    >
        ...
        >
            <g id="Layer_1">
                <g>
                    <circle
                        class="icon-contacts-circle-st0"
                        cx="32"
                        cy="32"
                        r="32"
                ...
                <g>
                    <g class="icon-contacts-circle-st1">
                        <path
                            class="icon-contacts-circle-st2"
                    ...
                    <g>
                        <path
                            class="icon-contacts-circle-st6"
                    ...
                    <g>
                        <rect
                            x="22"
                            y="12"
                            class="icon-contacts-circle-st7"
                            width="3"
                            height="40"
                        />
                    </g>
                    ...
                    <g>
                        <g>
                            <path
                                class="icon-contacts-circle-st8"
                    ...
                    <g>
                        <circle
                            class="icon-contacts-circle-st9"
                            cx="36"
                            cy="27"
                            r="4"
                        />
...
<style type="text/css">
.icon-contacts-circle-st0 {
    fill: #c75c5c;
}
.icon-contacts-circle-st1 {
    opacity: 0.2;
}
.icon-contacts-circle-st2 {
    fill: #231f20;
}
.icon-contacts-circle-st3 {
    fill: #77b3d4;
}
.icon-contacts-circle-st4 {
    fill: #ffffff;
}
.icon-contacts-circle-st5 {
    fill: #76c2af;
}
.icon-contacts-circle-st6 {
    fill: #e0995e;
}
.icon-contacts-circle-st7 {
    fill: #4f5d73;
}
.icon-contacts-circle-st8 {
    fill: #e0e0d1;
}
.icon-contacts-circle-st9 {
    fill: #f5cf87;
}
</style>
