...
<style type="text/css">
.icon-mail-circle-st0 {
    fill: #77b3d4;
}
.icon-mail-circle-st1 {
    opacity: 0.2;
}
.icon-mail-circle-st2 {
    fill: #231f20;
}
.icon-mail-circle-st3 {
    fill: #e0e0d1;
}
.icon-mail-circle-st4 {
    fill: #ffffff;
}
</style>
