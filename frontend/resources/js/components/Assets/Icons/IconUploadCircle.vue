  ...
  >
    ...
    >
      <g id="Layer_1">
        ...
        <g class="icon-upload-circle-st1">
          <g>
            <path
              class="icon-upload-circle-st2"
...
<style type="text/css">
.icon-upload-circle-st0 {
  fill: #76c2af;
}
.icon-upload-circle-st1 {
  opacity: 0.2;
}
.icon-upload-circle-st2 {
  fill: #231f20;
}
.icon-upload-circle-st3 {
  fill: #ffffff;
}
</style>
