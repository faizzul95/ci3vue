    ...
    >
        ...
        >
            <g id="Layer_1">
                ...
                <g class="icon-key-circle-st1">
                    <g>
                        <path
                            class="icon-key-circle-st2"
                            d="M47,18h-4c-0.2,0-0.5,0.1-0.7,0.2L28.5,30.4C27.8,30.2,26.7,30,26,30c-5.5,0-10,4.5-10,10s4.5,10,10,10
                ...
                <g>
                    <g>
                        <path
                            class="icon-key-circle-st3"
                            d="M47,16h-4c-0.2,0-0.5,0.1-0.7,0.2L28.5,28.4C27.8,28.2,26.7,28,26,28c-5.5,0-10,4.5-10,10s4.5,10,10,10
				s10-4.5,10-10c0-1.6-0.3-2.7-0.7-3.6l3.4-1.2c0.4-0.1,0.7-0.5,0.7-1l-0.1-3.8l3.8-0.3c0.5,0,0.9-0.5,0.9-1l0.1-4.6l3-0.7
